...
const sphereTexture = new THREE.TextureLoader().load("https://raw.githubusercontent.com/theastrogoth/Kerbal-Transfer-Illustrator/main/public/assets/icons/sphere.png");
