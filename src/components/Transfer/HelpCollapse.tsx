                    ...
                    <Table size="small">
                        <TableBody>
                            ...
                            <TableRow>
                                ...
                                <TableCell sx={{borderBottom: "none"}}>View the transfer trajectory using the orbit plots. Left-click and drag to rotate, right-click and drag to pan, and scroll to zoom. Click on bodies/crafts to see detailed information. Use the slider beneath the plot to view the system at different times throughout the transfer.</TableCell>
                            </TableRow>
                            <TableRow>
